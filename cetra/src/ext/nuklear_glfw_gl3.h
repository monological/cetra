...
NK_API void nk_glfw3_render(struct nk_glfw* glfw, enum nk_anti_aliasing, int max_vertex_buffer,
...
NK_INTERN void nk_glfw3_device_upload_atlas(struct nk_glfw* glfw, const void* image, int width,
                                            int height) {
    struct nk_glfw_device* dev = &glfw->ogl;
