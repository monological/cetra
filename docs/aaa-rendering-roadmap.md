...
**Tier 5's leftovers are down to two.** Rows 62 and 63 shipped as spec 11.95, taking the frame a
...
answer to a wall this document has booked features against for a dozen specs. Still open: 55b (one
denominator) and 61 (the frame-stale scene graph).
